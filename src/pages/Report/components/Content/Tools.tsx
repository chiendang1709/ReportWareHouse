    ...
    case 'Day': 
      return <div className='time__date'>
                 <div className="time__group">
                      ...
                      <input type="date" className="time__field" placeholder="Day" name="day" id='day' onChange={(e)=> setA(e.target.value)} required />
                 </div>
                 <div className="time__group">
                      <label htmlFor="day" className="time__label"> To (Day) </label>
                      <input type="date" className="time__field" placeholder="Day" name="day" id='day'  onChange={(e)=> setB(e.target.value)} required />
                 </div>
            </div>;
    ...
    case 'Month': 
      ...
      return  <div className='time__date'>
              <div className="time__group">
                   ...
                   <input type="month" className="time__field" placeholder="Month" name="Month" id='Month' onChange={(e)=> setA(e.target.value)} required />
              </div>
              <div className="time__group">
                   <label htmlFor="Month" className="time__label"> To (Month) </label>
                   <input type="month" className="time__field" placeholder="Month" name="Month" id='Month' onChange={(e)=> setB(e.target.value)} required />
              </div>
            </div>;
